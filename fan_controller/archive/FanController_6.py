...
class FanController:
    ...
    def check_fan_status(self):
        ...
        return self.read_register(self.REG_FAN_STATUS) or 0
    ...
    def check_stall_status(self):
        ...
        return self.read_register(self.REG_FAN_STALL_STATUS) or 0
    ...
    def check_drive_fail_status(self):
        ...
        return self.read_register(self.REG_DRIVE_FAIL_STATUS) or 0
